...
│
├───docs
│       AI Skin Analyzer - for Skin health.pdf
│
├───evaluation
│   ├───Custom CNN
...
│       Chatbot Final.ipynb
│       ResNet50 - 94%.ipynb
│       Skin Condition Classification Custom CNN 94%.ipynb
│       VGG16 - 95%.ipynb
│
├───Screanshots of Streamlit
│       Screenshot 2025-12-05 212142.png
│       Screenshot 2025-12-05 212719.png
│       Screenshot 2025-12-05 212812.png
│       Screenshot 2025-12-05 213226.png
│       Screenshot 2025-12-05 213249.png
│       Screenshot 2025-12-05 213447.png
│       Screenshot 2025-12-05 213809.png
│       Screenshot 2025-12-05 214008.png
│       Screenshot 2025-12-05 214611.png
│       Screenshot 2025-12-05 214931.png
│
└───test_images
        360_F_1419958115_fL6umGDMYecFoOR9akjIFwkMQXtAIUO5.jpg
        acne-severe.jpg
        closeup-asian-woman-with-dark-spots-freckles-problems-scaled.jpg
        Des-pores-dilatés-sur-une-peau-grasse-1080x1080.jpg
...
*   **📸 Image Dataset:** [Skin Issues Version 2 (Balanced)](https://www.kaggle.com/datasets/ahmedismaiil/skin-issues-version-2-dataset-balanced)  
    *Contains ~9,700 balanced images across 5 classes.*
*   **📄 Text Data:** Custom CSV datasets (Routine, Products, Issues) located in the `llm_knowledge_base` folder.
...
## 🚀 Installation & Hybrid Deployment
